...
const (
	...
	feedbackToken    = "e1a30562-3e12-45e2-8cca-4787b569515f"
)
...
Examples:
  notion-api feedback "the --filter regex syntax is unclear"
  notion-api feedback --about "create-widget" "exit code 0 but no output"
`,
